...
variation_visits = 12000
variation_clicks = 4500



#Assuming the sample size per week

sample_per_week = control_visits + variation_visits


#Calculating the click through rates

control_ctr = control_clicks/control_visits

variation_ctr = variation_clicks/variation_visits
  ...
  
{
  ...
  colnames(power_df)<- c('Power','Effect_Size','Control_CTR', 'Variation_CTR','Difference_CTR' ,'Sample_Size')
...
#Two sample difference in the proportion test
...
P2 = variation_clicks/variation_visits
